...
adb push ../exec/win/android_server64 /data/local/tmp/ida7x64
adb push ../exec/win/android_server /data/local/tmp/ida7x32
adb push ../exec/win/gdbserver64 /data/local/tmp/gx64
adb push ../exec/win/gdbserver /data/local/tmp/gx32
